            ...
            <div className="container">
                <div className="rc-carousel nav-control-layout2" data-loop="true" data-items="30" data-margin="5"
                    ...
                    <div className="ranna-slider-content-layout1">
                        <figure className="item-figure"><a href="single-recipe1.html"><img src="img/slider/slide1-1.jpg" alt="Product"/></a></figure>
                        <div className="item-content">
                            <span className="sub-title">SALAD</span>
                            <h2 className="item-title"><a href="single-recipe1.html">Italiano Salad Mixed</a></h2>
                    ...
                    <div className="ranna-slider-content-layout1">
                        <figure className="item-figure"><a href="single-recipe1.html"><img src="img/slider/slide1-2.jpg" alt="Product"/></a></figure>
                        <div className="item-content">
                            <span className="sub-title">SALAD</span>
                            <h2 className="item-title"><a href="single-recipe1.html">Italiano Salad Mixed</a></h2>
                            <ul className="item-rating">
                    ...
                    <div className="ranna-slider-content-layout1">
                        <figure className="item-figure"><a href="single-recipe1.html"><img src="img/slider/slide1-3.jpg" alt="Product"/></a></figure>
                        <div className="item-content">
                            <span className="sub-title">SALAD</span>
                            <h2 className="item-title"><a href="single-recipe1.html">Italiano Salad Mixed</a></h2>
                            <ul className="item-rating">
